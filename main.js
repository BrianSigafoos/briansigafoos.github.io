...
%o`, message, error2, detail);
  ...
  var color_scheme_controller_default = class extends Controller {
    ...
    get currentScheme() {
      ...
      if (fromLocal) {
        DevLog_default(["Color scheme found in localStorage", fromLocal]);
        return fromLocal;
      }
      const darkFromOS = window.matchMedia("(prefers-color-scheme: dark)").matches;
      if (darkFromOS) {
        DevLog_default(["Color scheme found at OS level as dark"]);
        return DARK_SCHEME;
      }
      return LIGHT_SCHEME;
    }
    ...
    get currentColor() {
      ...
      if (fromLocal) {
        DevLog_default(["Color primary found in localStorage", fromLocal]);
        return fromLocal;
      }
      return COLORS[0];
    }
  ...
  Stimulus.register("color-scheme", color_scheme_controller_default);
})();
